...
{
    /// <inheritdoc />
    public partial class Add_Pizza_App_Base_Schema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BaseIngredients = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ExtraToppingOrderItem",
                columns: table => new
                {
                    ExtraToppingsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderItemsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraToppingOrderItem", x => new { x.ExtraToppingsId, x.OrderItemsId });
                    table.ForeignKey(
                        name: "FK_ExtraToppingOrderItem_ExtraToppings_ExtraToppingsId",
                        column: x => x.ExtraToppingsId,
                        principalTable: "ExtraToppings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtraToppingOrderItem_OrderItems_OrderItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtraToppingOrderItem_OrderItemsId",
                table: "ExtraToppingOrderItem",
                column: "OrderItemsId");
